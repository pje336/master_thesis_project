...
def load_voxelmorph_model(trained_model_folder, epoch = None):
    ...
    if epoch is None:
        ...
        epoch = len(glob.glob(trained_model_folder + "/voxelmorph_model_epoch_*.pth")) - 1

    model_dict_filename = trained_model_folder + "/voxelmorph_model_epoch_{}.pth".format(epoch)
