...
if NCC:
  losses = [Voxelmorph_model.voxelmorph.torch.losses.NCC().loss, Voxelmorph_model.voxelmorph.torch.losses.NCC().loss, Voxelmorph_model.voxelmorph.torch.losses.Grad('l2').loss]
...
trained_model_folder = "training_2022_07_02_07_48_17"
trained_epoch = 7
load_pretrained_model = False
tanh_value = 6
print(tanh_value, flush=True)

model = Voxelmorph_model.voxelmorph.networks.VxmDense(data_shape, nb_features, int_downsize=int_downsize, bidir=True, dropout = dropout_rate, tanh = tanh_value)
