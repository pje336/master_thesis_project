...
def contour_viewer(volumes, title = None, shape = None, flow_field = None):
    """
    ...
    """
    #
    cmap = colors.ListedColormap(['darkorange', 'blue','red','yellow','orange','lawngreen','lightseagreen','pink'])
